...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            //emp.Salary > 1000).OrderByDescending(Emp => Emp.Ename).ToList();
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Union(new Emp[]
                {
                    new Emp
                    {
                        Ename = "Brak wartości",
        ...
        {
            int result = arr.GroupBy(c => c).GroupBy(g => g.Count() % 2 == 1).ToList()
                .Where(c => c.Key).Last().ElementAt(0).Key;
            return result;
        }
