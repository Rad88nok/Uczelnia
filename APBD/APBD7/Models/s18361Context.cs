...
{
    public partial class s18361Context : DbContext
    {
        public s18361Context()
        {

        }

        public s18361Context(DbContextOptions<s18361Context> options): base(options)
        {
        }
        ...
        //    {
        //        optionsBuilder.UseSqlServer("MssqlDbConnString", builder => builder.EnableRetryOnFailure());
        //    }
        //}
